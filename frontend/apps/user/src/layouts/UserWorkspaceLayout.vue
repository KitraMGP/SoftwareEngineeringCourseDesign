...
<template>
  <div class="relative min-h-screen overflow-hidden">
    ...
    <div class="relative z-10 mx-auto flex min-h-screen max-w-[1560px] gap-4 px-4 py-4 lg:h-screen lg:min-h-0 lg:px-5 lg:py-5">
      ...
      <main class="relative flex min-h-[calc(100vh-2rem)] flex-1 flex-col overflow-hidden rounded-[28px] border border-white/60 bg-white/66 shadow-soft backdrop-blur-xl lg:min-h-[calc(100vh-2.5rem)] lg:h-[calc(100vh-2.5rem)]">
